...
<template>
    <VDialog :showModal="openDialog" :title="updateAction ? 'Update Departemen' : 'Create Departemen'" @opened="openForm" @closed="closeForm" size="xl">
        ...
        <template v-slot:content>
            <div class="grid grid-cols-2 gap-3">
                <div class="col-span-2">
                    <VInput placeholder="Insert Departemen" label="Departemen" :required="true" v-model="form.name" :errorMessage="formError.name"
